...
const Hero: React.FC = () => {
  ...
  return (
    <section className="hero bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#38BDF8] relative">
      <div className="hero-content container-custom py-32">
        <div className={`max-w-4xl mx-auto text-center ${isVisible ? 'fade-in-up' : 'opacity-0'}`}>
          ...
          <p className={`text-xl md:text-2xl mb-8 text-[#D1D5DB] max-w-3xl mx-auto leading-relaxed ${isVisible ? 'fade-in-up-delay-1' : 'opacity-0'}`}>
