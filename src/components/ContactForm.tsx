              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <input type="tel" id="phone" name="phone" required value={formData.phone} onChange={handleChange}
                    placeholder="e.g., 7911123456" className={`w-2/3 bg-background/50 border rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary ${errors.phone ? 'border-red-500' : 'border-gray-700'}`} />
                </div>
