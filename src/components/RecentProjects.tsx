...
const RecentProjects: React.FC = () => {
  ...
  const project = {
    ...
    description:
      "A comprehensive staffing platform connecting businesses with skilled professionals. Built with modern web technologies and AI-powered matching algorithms.",
    features: [
